...
// GL ES1 fixed-function calls below are provided by the jwzgles ES1-over-ES2 wrapper
// (-DHAVE_JWZGLES). The real GLES1 header must come first: it defines GL_VERSION_ES_CM_1_0
// and the base GL types that jwzglesI.h needs; jwzgles.h then redefines gl* -> jwzgles_gl*.
#include <GLES/gl.h>
#include "jwzgles.h"
